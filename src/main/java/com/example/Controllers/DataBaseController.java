...
public class DataBaseController implements CommandLineRunner {
    ...
    private void initDatabase() {
		...
		Owner owner1 = new Owner("78945329G", "Ownername1","OwnerSurname", 695339576, "abcdf-1234-5678");
		Owner owner2 = new Owner("12242329H", "Ownername2","OwnerSurname", 695339576, "abcdf-1234-5678");
		Owner owner3 = new Owner("87645329S", "Ownername3","OwnerSurname", 695339576, "abcdf-1234-5678");
		Owner owner4 = new Owner("32945329Y", "Ownername4","OwnerSurname", 695339576, "abcdf-1234-5678");
		Owner owner5 = new Owner("23945329A", "Ownername5","OwnerSurname", 695339576, "abcdf-1234-5678");
		Owner owner6 = new Owner("38945329B", "Ownername6","OwnerSurname", 695339576, "abcdf-1234-5678");
